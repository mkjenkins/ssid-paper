...
There are far-reaching implications of the SSID list data. One such implication is the 
possibility of a creating a location narrative based on  the information from this list. 
...
due to our filtering strategies, the same strategies can be maliciously. 
